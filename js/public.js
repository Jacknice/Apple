...
$(function () {
    $(window).on('scroll', function () {
        ...
        if ($scroll >=200) {
            ...
            $(".header_logo_menu .logo").find("img").attr("src","images/Index/logo_b.png");
        } else {
            $(".header_logo_menu").removeClass("header_logo_menu_hover");
            $(".header_logo_menu .logo").find("img").attr("src","images/Index/logo.png");
        }
    })
});
/*!
    ...
    a.A6={
        ...
        counter:function(){
            if($('#fixed-bottom-bar').length<=0){
                $('body').append('<div class="fixed-bottom-box"><div id="fixed-bottom-bar"class="fixed-bottom-bar"><div class="close">×</div><div class="box container row"><div class="col-xs-5"><img src="http://icon.dyrs.cc/bottom-bar-1.png" width="465" height="77"></div><div class="col-xs-5"><div class="myform"><form id="fixed-bottom-form" action="/api/user/appoint.php"method="post"><input type="hidden" name="action" value="footer"><div class="row"><div class="col-xs-6"><div class="input"><input name="name" type="text" id="name-txt" data-tit="您的姓名"></div></div><div class="col-xs-6"><div class="input"><input name="phone" type="text" id="phone-txt" data-tit="您的手机号"></div></div><div class="col-xs-6"><div class="input"><input name="acreage" type="text" id="acreage-txt" data-tit="建筑面积"><label class="unit">㎡</label></div></div><div class="col-xs-6 "><div class="input"><input name="loupan" type="text" id="name-txt" data-tit="楼盘名称"></div></div></div><button type="submit" id="fixed-bottom-submit">获取<br>报价</button></form></div></div><div class="col-xs-2"><p class="tel-tit">免费电话报价</p><p class="tel-num">400-6600-598</p></div></div><div class="shadow"></div></div><div class="down-bar-btn"><p>获取报价</p></div></div>');
                // 获取风格偏好列表
